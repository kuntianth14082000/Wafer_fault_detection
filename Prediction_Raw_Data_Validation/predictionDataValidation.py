...
class Prediction_Data_validation:
    ...
    def deleteExistingBadDataPredictionFolder(self):
        ...
        try:
            ...
            if os.path.isdir(path + "Bad_Raw/"):
                ...
                file = open("Prediction_Logs/GeneralLog.txt", 'a+')
                self.logger.log(file,"Bad_Raw  Directory deleted Successfully Before starting validation!!!")
                file.close()
    ...
    def validationFileNameRaw(self,regex,LengthOfDateStampInFile,LengthOfTimeStampInFile):
        ...
        onlyfiles  = [f for f in listdir(self.Batch_Directoty)]
        try:
    ...
    def deletePredicitionFile(self):
